      ...
      <div className="border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 gap-3 sm:gap-6">
            ...
            >
              <CivicEmblem size={34} className="group-hover:scale-105 transition-transform" />
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-serif text-lg font-bold tracking-tight text-white group-hover:text-blue-200 transition-colors">
                    Apna Neta
                  </span>
            ...
            {/* Center: Spacious Search Omnibar */}
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              {onOpenCivicGuide && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800/80 hover:bg-slate-700 text-amber-300 hover:text-amber-200 border border-slate-700 rounded-xl text-xs font-medium transition-all shadow-xs"
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0">
                ...
                <select
                  ...
                  className="text-xs bg-slate-800/90 border border-slate-700 rounded-xl px-2.5 py-1.5 font-medium text-slate-200 outline-none focus:ring-1 focus:ring-blue-400 cursor-pointer hover:bg-slate-700/80 transition-colors"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                className="flex items-center bg-slate-800/90 p-0.5 rounded-xl border border-slate-700/90 shadow-xs"
                title={
                  isCitizenMode
